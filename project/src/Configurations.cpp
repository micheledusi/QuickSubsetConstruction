...
//		load(AutomatonStructure, AUTOMATON_ACYCLIC);
	...
	const Configurations::Setting Configurations::settings_list[] = {
			...
			{ AutomatonMaxLevel , 			"Automaton's max level", 					"maxlevel", true },
			{ AutomatonSafeZoneLevel , 		"Automaton's safe-zone level", 				"safezonelevel", true },
			...
			{ ActiveLevelCheckInTranslation , "Active \"level check in translation\"", "?levelcheck",  false },
